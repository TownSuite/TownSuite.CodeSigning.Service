                ...
                stage('Windows Build and Code Signing') {
                    ...
                    steps {
                        ...
                        withCredentials([
                            ...
                            pwsh '''
                            $CodeSigningClient = ".\\bin\\Release\\net8.0\\win-x64\\publish\\TownSuite.CodeSigning.Client.exe"
                            & $CodeSigningClient -rfolder "build|*TownSuite*.dll;*TownSuite*.exe" -url "$CODESIGNING_SERVICE_URL" -timeout 60000 -token "$CODESIGNING_AUTH_KEY" -ignorecerts
                            '''
                        }
